...
* **การแสดงผลรูปธงชาติ (OS Emojis):** ระบบปฏิบัติการ Windows ไม่รองรับการแสดงผล Color Emoji รูปธงชาติ หากเปิดผ่านเบราว์เซอร์บน Windows อาจเห็นเป็นตัวอักษรย่อประเทศแทน แต่จะแสดงผลเป็นรูปธงชาติปกติเมื่อเปิดผ่าน macOS, iOS หรือ Androidomation อยู่ที่ 100 ครั้ง/เดือน หากโควต้าหมด Webhook จะไม่ถูกส่ง (แนะนำให้นำไป Implement บน Jira ระดับ Production ขององค์กร)
