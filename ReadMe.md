# 🚀 Automated SOC Triage Bot (Jira Integration)
...
AbuseIPDB: ตรวจสอบประวัติพฤติกรรมไม่พึงประสงค์ (เช่น สแกนพอร์ต, โจมตี) ระบุระดับความเสี่ยง (%) และดึงสถานะ Whitelist เพื่อป้องกัน FalsePositive
